...
# ... (Keep compress_image function as is) ...
...
class Region(models.Model):
    name = models.CharField(max_length=50, help_text="e.g. NTSC-U, NTSC-J, PAL, Region Free")
    slug = models.SlugField(unique=True)
...
class Game(models.Model):
    # Removed old REGION_CHOICES tuple
...
# ... (Keep GameComponent and GameVideo exactly as they were) ...
